...
=item * Changed the GPL text in LICENSE to GPL-1 (2011-02-13)

Note that this isn't a change in what license the module is released
...
=item * Added tests for case insensitivity
